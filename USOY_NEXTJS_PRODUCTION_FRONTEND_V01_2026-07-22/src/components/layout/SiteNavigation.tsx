  ...
  return <>
    <nav className="desktop-nav" aria-label="Päänavigaatio">
      <div className="nav-dropdown" ref={dropdownRef}>
        ...
        <div id="desktop-service-menu" className="nav-dropdown__panel" hidden={!dropdownOpen}>{serviceNavigation.map((item) => <NavLink key={item.href} {...item} onNavigate={() => setDropdownOpen(false)} />)}</div>
      </div>
